...
export function UploadCloud({ size = 24, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Bot({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Trash2({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldCheck({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function RefreshCw({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Layers({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
